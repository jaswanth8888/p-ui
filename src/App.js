        ...
        <BrowserRouter>
          <Switch>
            ...
            <Route exact={true} path="/store">
              {isLoggedIn ? <StoreForm /> : <Redirect to="/" />}
            </Route>
            <Route exact={true} path="/zonepage">
              {isLoggedIn ? <ZoneForm /> : <Redirect to="/" />}
            </Route>
            <Route exact={true} path="/cluster">
              {isLoggedIn ? <ClusterForm /> : <Redirect to="/" />}
            </Route>
            <Route exact={true} path="/viewzones">
              {isLoggedIn ? <ViewZones /> : <Redirect to="/" />}
            </Route>
            <Route exact={true} path="/viewclusters">
              {isLoggedIn ? <ViewClusters /> : <Redirect to="/" />}
            </Route>
          </Switch>
        </BrowserRouter>
        {/* <Router>
