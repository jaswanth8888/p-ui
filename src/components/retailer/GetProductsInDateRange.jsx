        ...
        <div className="joint-form">
          <div className="validation-half" style={{ background: "#673ab7" }}>
            <div className="validations">
                ...
                {this.state.startDate <= this.state.currentDate && <div style={{ display: "flex" }}><ClearIcon style={{ paddingRight: "5px", marginTop: "-2px" }} />
                  <Typography variant="subtitle2" gutterBottom>
                    Start date has to be a future Date
                  </Typography></div>}
                  {this.state.startDate >= this.state.currentDate && <div style={{ display: "flex" , color: "#ffc107" }}><CheckIcon style={{ paddingRight: "5px", marginTop: "-2px" }} />
                  <Typography variant="subtitle2" gutterBottom>
                    Start date has to be a future Date
                  </Typography></div>}
          ...
          <div className="form-half">
            <form className="{classes.form}" noValidate >
              ...
              <TextField
                ...
                autoFocus
              />
              {( this.state.startDate >= this.state.currentDate) && (this.state.endDate > this.state.startDate) &&
              <Link to='/view/effectiveprices' style = {{textDecoration : "none"}}>
              <Button
                type="button"
                fullWidth
                variant="contained"
                ...
                onClick={this.props.getPricesInRange(this.state.startDate,this.state.endDate,this.state.currentDate)}
...
const actionAsProps = {
    getPricesInRange : getPricesInRange
  }
