      ...
      if(sessionStorage.getItem("token")!=null){
        ...
        return (
            ...
            <div className="validations">
              ...
              {this.state.isSubmitted && !this.state.product.productName && <div style={{ display: "flex" }}><ClearIcon style={{ paddingRight: "5px", marginTop: "-2px" }} />
                <Typography variant="subtitle2" gutterBottom>
                name can't be empty
                </Typography></div>}
              {this.state.isSubmitted && this.state.product.productBasePrice<=0 &&
                <div style={{ display: "flex", color: "#ffc107" }}><CheckIcon style={{ paddingRight: "5px", marginTop: "-2px" }} />
                  <Typography variant="subtitle2" gutterBottom>
                  base price must be greater than 0
                </Typography></div>}
                {this.state.isSubmitted && this.state.product.initialQuantity<1 &&
                <div style={{ display: "flex", color: "#ffc107" }}><CheckIcon style={{ paddingRight: "5px", marginTop: "-2px" }} />
                  <Typography variant="subtitle2" gutterBottom>
                  >minimum quantity should be 1 
                </Typography></div>}
                {this.state.isSubmitted && this.state.product.productCategory==="ALCOHOL_PROD" && this.state.product.initialQuantity>100 &&
                <div style={{ display: "flex", color: "#ffc107" }}><CheckIcon style={{ paddingRight: "5px", marginTop: "-2px" }} />
                  <Typography variant="subtitle2" gutterBottom>
                  maximum quantity of ALCOHOL should be 100
                </Typography></div>}
                {this.state.isSubmitted && this.state.product.productCategory==="BABY_PROD"&&this.state.product.initialQuantity>500 &&
                <div style={{ display: "flex", color: "#ffc107" }}><CheckIcon style={{ paddingRight: "5px", marginTop: "-2px" }} />
                  <Typography variant="subtitle2" gutterBottom>
              ...
              <TextField
                ...
                autoFocus
              />
              <InputLabel htmlFor="outlined-age-native-simple">Product Category</InputLabel>
              <Select labelId="productCategory" 
              fullWidth
              variant="outlined"
              margin="normal"
              required
            ...
            <TextField
              ...
              <TextField
                ...
                autoFocus
              />
          <InputLabel htmlFor="outlined-age-native-simple">Units Of Measuremment</InputLabel>
